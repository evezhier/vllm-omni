...
class TalkerMTPCudaGraphWrapper:                                                                                                                                                                                                                                                                                         
    ...
    - Code predictor forward (residual codebooks)                                                                                                                                                                                                                                                                        
    - Embedding summation                                                                                                                                                                                                                                                                                                
    - Text step addition                                                                                                                                                                                                                                                                                                 
    """                                    
    # TODO
    ...
    def __init__(self, talker_model, talker_config, capture_sizes, device='cuda'):                                                                                                                                                                                                                                                             
        self.device = device                                                                                                                                                                                                                                                                                             
    ...
    def _mtp_forward(self):                                                                                                                                                                                                                                                                                              
        ...
        # Code predictor forward (DETERMINISTIC - no sampling in graph)                                                                                                                                                                                                                                                  
        ...
        for i in range(self.num_code_groups - 1): # max_steps                                                                                                                                                                                                                                                                        
